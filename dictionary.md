...
**full_image**: This is a flag (valid values are 0/1, default=0) indicating that the full image should be used and that the uv spacing should be set based on the image size. This keyword cannot be set if **delta_uv_lambda** is set.
