...
function kpower_slice, power_3d, kx_mpc, ky_mpc, kz_mpc, kperp_lambda_conv, delay_params, hubble_param, noise_3d = noise_3d, $
                       weights_3d = weights_3d, slice_axis = slice_axis, slice_inds = slice_inds, slice_weights = weights, $
  ...
  if n_elements(slice_savefile) eq 1 then $
     save, file = slice_savefile, power, noise, weights, kperp_lambda_conv, delay_params, hubble_param, $
